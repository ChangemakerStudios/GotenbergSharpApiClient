...
public sealed class UrlScreenshotRequestBuilder() : BaseScreenshotBuilder<UrlScreenshotRequest, UrlScreenshotRequestBuilder>(new UrlScreenshotRequest())
{
    public UrlScreenshotRequestBuilder SetUrl(string url)
    {
    ...
    public UrlScreenshotRequestBuilder SetUrl(Uri url)
    {
    ...
    public UrlScreenshotRequestBuilder AddHeaderFooter(Action<UrlHeaderFooterBuilder> action)
    {
    ...
    public UrlScreenshotRequestBuilder AddAsyncHeaderFooter(Func<UrlHeaderFooterBuilder, Task> asyncAction)
    {
    ...
    public UrlScreenshotRequestBuilder AddExtraResources(Action<UrlExtraResourcesBuilder> action)
    {
        if (action == null) throw new ArgumentNullException(nameof(action));

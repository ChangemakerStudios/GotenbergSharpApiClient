...
/// <summary>
/// Represents a Gotenberg API screenshot capture request for HTML or Markdown content.
/// </summary>
/// <remarks>
/// For Markdown screenshots your Content.Body must contain HTML that references one or more markdown files
...
/// </remarks>
public sealed class HtmlScreenshotRequest(bool containsMarkdown) : ScreenshotRequest
{
    public HtmlScreenshotRequest()
        : this(false)
    {
    }
    ...
    protected override string ApiPath =>
        this.ContainsMarkdown
            ? Constants.Gotenberg.Chromium.ApiPaths.ScreenshotMarkdown
            : Constants.Gotenberg.Chromium.ApiPaths.ScreenshotHtml;
